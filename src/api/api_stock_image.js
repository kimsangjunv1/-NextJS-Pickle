...
export default class ApiImage {
  constructor() {
    const baseURL = process.env.NEXT_PUBLIC_RAPID_IMAGE_URL;
    const baseHOST = process.env.NEXT_PUBLIC_RAPID_IMAGE_HOST;
    const baseKEY = process.env.NEXT_PUBLIC_RAPID_IMAGE_KEY;
